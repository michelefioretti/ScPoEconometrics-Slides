...
```{r, echo = FALSE, eval=FALSE}
# NOTE: change the page of the book
```
--
...
* Before delving into these assumptions, let's see the small but important modifications we apply to our model (back to [*lecture 4: Simple Linear Regression*](https://raw.githack.com/ScPoEcon/ScPoEconometrics-Slides/master/chapter3/chapter3.html#1)):

```{r,eval=FALSE,echo=FALSE}
# Note: change this link!
```
