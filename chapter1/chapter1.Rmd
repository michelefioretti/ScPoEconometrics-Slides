...
- We will meet every Wednesday at 8.00 AM (GMT+2) on Zoom. 
...
--
ou will spend a lot of time preparing data for further analysis.
...
* Help from Humans!
  ...
  * [stackoverflow.com](https://stackoverflow.com) [S* Your classroom channel on SlaSlack. If you haven't joined click [here](https://join.slack.com/t/applieddata/shared_invite/zt-h8gsmw9y-xdzV46sY5T2ldgK74u~0Mw) to join* [rstudio forum](https://community.rstudio.com)
...
* Find out (using `hegle) how to import a .csv file.

* Import [gun_murders.csv](https://www.dropbox.com/s/zuk0qcfm3kyzs4e/gun_murders.csv?dl=1)<sup>1</sup> in a new object `murders`. This file contains data on gun murders by US state in 2010. (Hint: objects are created using `=`either )
